    ...
    <body ng-app="">
        ...
        <div class="frame">
            <section class="content" style="background-color: #f00; padding-top: 10%;">
                <div class="block">
                    <h3 class="block-title">Inserisci Oggetti Per L'Estrazione</h3>
                    <div class="block-content">
                        <form class="frame" action="insertobj_query.php" method="POST">                            
                            <input name="obj" type="text" placeholder="Oggetto">                                                    
                            <button class="button" type="submit" id="login">Inserisci</button>
                        </form>
                    </div>
                </div>         
            </section>
